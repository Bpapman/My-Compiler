...
* THEN
 ...
 54:    LDA  7,20(7) 	Jump around the THEN [backpatch] 
* ENDIF
* END compound statement
 75:    LDA  7,-31(7) 	go to beginning of loop 
 54:    LDA  7,21(7) 	No more loop 
* ENDWHILE
* 			Begin call to  output
 76:     ST  1,-3(1) 	Store old fp in ghost frame 
* 			Load Param 1
 77:    LDC  3,666(6) 	Load constant 
...
* END init of globals
 ...
 90:    LDA  3,0(7) 	return address in ac 
