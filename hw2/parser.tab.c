...
{
       0,    59,    59,    62,    74,    77,    78,    84,    94,   105,
     116,   119,   120,   123,   124,   127,   128,   131,   132,   133,
     138,   139,   142,   143,   146,   157,   160,   170,   181,   184,
     185,   189,   190,   193,   194,   195,   196,   199,   202,   213,
     216,   227,   230,   231,   234,   235,   236,   237,   240,   241,
     242,   243,   246,   247,   250,   256,   275,   294,   313,   314,
     315,   318,   336,   339,   357,   360,   361,   364,   365,   368,
     369,   370,   371,   372,   373,   376,   377,   380,   381,   384,
     385,   388,   389,   390,   393,   394,   397,   398,   401,   402,
     405,   406,   409,   410,   411,   414,   417,   418,   421,   432,
     435,   436,   437,   438,   439
};
#endif
...
/* Line 1806 of yacc.c  */
#line 120 "parser.y"
    { (yyval.tNode) = (yyvsp[(1) - (3)].tNode); (yyval.tNode)->child[0] = (yyvsp[(3) - (3)].tNode); }
    break;
...
/* Line 1806 of yacc.c  */
#line 360 "parser.y"
    { (yyval.tNode) = newExpNode(opK,yylval.tokenData->lineno); (yyval.tNode)->attr.op = notK; (yyval.tNode)->child[0]=(yyvsp[(2) - (2)].tNode); }
    break;
...
/* Line 1806 of yacc.c  */
#line 364 "parser.y"
    { (yyval.tNode) = (yyvsp[(2) - (3)].tNode); (yyval.tNode)->child[0] = (yyvsp[(1) - (3)].tNode); (yyval.tNode)->child[1] = (yyvsp[(3) - (3)].tNode); }
    break;
...
/* Line 1806 of yacc.c  */
#line 393 "parser.y"
    { (yyval.tNode) = (yyvsp[(1) - (2)].tNode); (yyval.tNode)->child[0]=(yyvsp[(2) - (2)].tNode); }
    break;
...
/* Line 1806 of yacc.c  */
#line 406 "parser.y"
    { (yyval.tNode) = newExpNode(idK,(yyvsp[(1) - (4)].tokenData)->lineno); (yyval.tNode)->child[0] = (yyvsp[(3) - (4)].tNode); (yyval.tNode)->attr.name=(yyvsp[(1) - (4)].tokenData)->idvalue; }
    break;
...
/* Line 1806 of yacc.c  */
#line 435 "parser.y"
    { (yyval.tNode) = newExpNode(constK,yylval.tokenData->lineno); (yyval.tNode)->attr.val = (yyvsp[(1) - (1)].tokenData)->numvalue; (yyval.tNode)->expType=Int; }
    break;
...
/* Line 1806 of yacc.c  */
#line 436 "parser.y"
    { (yyval.tNode) = newExpNode(constK,yylval.tokenData->lineno); (yyval.tNode)->attr.string = (yyvsp[(1) - (1)].tokenData)->tokenstr; (yyval.tNode)->expType=Char; }
    break;
