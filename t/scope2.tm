...
* EXPRESSION STMT
*                       Begin call to  output
 99:     ST  1,-7(1) 	Store old fp in ghost frame 
*                       Load param 1
100:     LD  3,-3(1) 	Load variable a
101:     ST  3,-9(1) 	Store parameter 
*                       Jump to output
102:    LDA  1,-7(1) 	Load address of new frame 
...
* EXPRESSION STMT
*                       Begin call to  output
106:     ST  1,-7(1) 	Store old fp in ghost frame 
*                       Load param 1
107:     LD  3,-4(1) 	Load variable b
108:     ST  3,-9(1) 	Store parameter 
*                       Jump to output
...
* EXPRESSION STMT
*                       Begin call to  output
120:     ST  1,-7(1) 	Store old fp in ghost frame 
*                       Load param 1
121:     LD  3,-2(1) 	Load variable x
122:     ST  3,-9(1) 	Store parameter 
*                       Jump to output
123:    LDA  1,-7(1) 	Load address of new frame 
...
* EXPRESSION STMT
*                       Begin call to  outnl
127:     ST  1,-7(1) 	Store old fp in ghost frame 
*                       Jump to outnl
128:    LDA  1,-7(1) 	Load address of new frame 
129:    LDA  3,1(7) 	Return address in ac 
130:    LDA  7,-94(7) 	CALL outnl
131:    LDA  3,0(2) 	Save the result in ac 
*                       End call to outnl
* EXPRESSION STMT
132:    LDC  3,11(6) 	Load constant 
133:     ST  3,-3(1) 	Store variable a
* EXPRESSION STMT
134:    LDC  3,12(6) 	Load constant 
135:     ST  3,-4(1) 	Store variable b
* EXPRESSION STMT
136:    LDC  3,14(6) 	Load constant 
137:     ST  3,-2(1) 	Store variable x
* BEGIN compound statement
* EXPRESSION STMT
138:    LDC  3,15(6) 	Load constant 
139:     ST  3,-2(1) 	Store variable x
* END compound statement
* EXPRESSION STMT
*                       Begin call to  output
140:     ST  1,-7(1) 	Store old fp in ghost frame 
*                       Load param 1
141:     LD  3,-3(1) 	Load variable a
142:     ST  3,-9(1) 	Store parameter 
*                       Jump to output
...
* EXPRESSION STMT
*                       Begin call to  output
147:     ST  1,-7(1) 	Store old fp in ghost frame 
*                       Load param 1
148:     LD  3,-4(1) 	Load variable b
149:     ST  3,-9(1) 	Store parameter 
*                       Jump to output
...
* EXPRESSION STMT
*                       Begin call to  output
154:     ST  1,-7(1) 	Store old fp in ghost frame 
*                       Load param 1
...
* EXPRESSION STMT
*                       Begin call to  output
161:     ST  1,-7(1) 	Store old fp in ghost frame 
*                       Load param 1
