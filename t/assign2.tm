...
*                       End call to output
* EXPRESSION STMT
 68:    LDC  3,4(6) 	Load constant 
 69:     ST  3,-32(1) 	Save index 
 70:    LDC  3,222(6) 	Load constant 
...
*                       End call to outnl
* EXPRESSION STMT
124:    LDC  3,5(6) 	Load constant 
125:     ST  3,-32(1) 	Save index 
126:    LDC  3,333(6) 	Load constant 
...
*                       End call to output
* EXPRESSION STMT
262:    LDC  3,3(6) 	Load constant 
263:     ST  3,-32(1) 	Save index 
264:    LDC  3,2(6) 	Load constant 
...
295:    LDC  3,7(6) 	load size of array gx
296:     ST  3,0(0) 	save size of array gx
297:    LDC  3,6(6) 	load size of array gy
298:     ST  3,-8(0) 	save size of array gy
299:    LDC  3,5(6) 	load size of array ga
300:     ST  3,-15(0) 	save size of array ga
301:    LDC  3,4(6) 	load size of array gb
302:     ST  3,-21(0) 	save size of array gb
* END init of globals
303:    LDA  1,-26(0) 	set first frame at end of globals 
