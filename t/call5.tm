...
* END of function main
  0:    LDA  7,175(7) 	Jump to init [backpatch] 
* BEGIN Init
176:     LD  0,0(0) 	Set the global pointer 
* BEGIN init of globals
* END init of globals
177:    LDA  1,-1(0) 	set first frame at end of globals 
178:     ST  1,0(1) 	store old fp (point to self) 
179:    LDA  3,1(7) 	Return address in ac 
180:    LDA  7,-87(7) 	Jump to main 
181:   HALT  0,0,0 	DONE! 
* END Init
