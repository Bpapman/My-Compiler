...
Statement:  ID                  { cout << "Line " << yylval.tokenData->linenum << " Token: ID Value: " << yylval.tokenData->tokenstr << endl; }
            ...
            |RETURN             { cout << "Line " << yylval.tokenData->linenum << " Token: " << "RETURN" << endl; }
            ...
            |NEQ                { cout << "Line " << yylval.tokenData->linenum << " Token: NEQ" << endl; }
            |LEQ                { cout << "Line " << yylval.tokenData->linenum << " Token: LEQ" << endl; }
            |LESSER             { cout << "Line " << yylval.tokenData->linenum << " Token: <" << endl; }
            |GEQ                { cout << "Line " << yylval.tokenData->linenum << " Token: GEQ" << endl; }
            |GREATER            { cout << "Line " << yylval.tokenData->linenum << " Token: >" << endl; }
            |ASSIGN             { cout << "Line " << yylval.tokenData->linenum << " Token: =" << endl; }
            |PASSIGN            { cout << "Line " << yylval.tokenData->linenum << " Token: PASSIGN" << endl; }
            |MASSIGN            { cout << "Line " << yylval.tokenData->linenum << " Token: MASSIGN" << endl; }
            |DEC                { cout << "Line " << yylval.tokenData->linenum << " Token: DEC" << endl; }
            |INC                { cout << "Line " << yylval.tokenData->linenum << " Token: INC" << endl; }
