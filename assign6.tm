...
163:    SUB  3,4(3) 	Compute offset for b
164:     LD  3,0(3) 	load value for b
...
182:    SUB  3,4(3) 	Compute offset for b
183:     LD  3,0(3) 	load value for b
...
201:    SUB  3,4(3) 	Compute offset for b
202:     LD  3,0(3) 	load value for b
...
223:    SUB  3,4(3) 	Compute offset for h
224:     LD  3,0(3) 	load value for h
...
242:    SUB  3,4(3) 	Compute offset for h
243:     LD  3,0(3) 	load value for h
...
261:    SUB  3,4(3) 	Compute offset for h
262:     LD  3,0(3) 	load value for h
...
* EXPRESSION STMT
* EXPRESSION STMT
273:    LDC  3,1(6) 	Load constant 
274:     ST  3,-17(1) 	Save index 
* EXPRESSION STMT
275:    LDC  3,777(6) 	Load constant 
276:     LD  4,-17(1) 	Restore index 
277:    LDA  5,-3(1) 	Load address of base of array q
...
282:    LDA  4,-3(1) 	Load address of base of array q
283:    SUB  3,4(3) 	Compute offset for q
284:     LD  3,0(3) 	load value for q
...
* EXPRESSION STMT
* EXPRESSION STMT
290:    LDC  3,1(6) 	Load constant 
291:     ST  3,-17(1) 	Save index 
* EXPRESSION STMT
292:    LDC  3,666(6) 	Load constant 
293:     LD  4,-17(1) 	Restore index 
294:    LDA  5,-3(1) 	Load address of base of array q
295:    SUB  5,5,4 	Compute offset of value 
296:     LD  4,0(5) 	loah lhs variable q
297:    ADD  3,4,3 	op += 
...
301:    LDA  4,-3(1) 	Load address of base of array q
302:    SUB  3,4(3) 	Compute offset for q
303:     LD  3,0(3) 	load value for q
...
* EXPRESSION STMT
* EXPRESSION STMT
309:    LDC  3,1(6) 	Load constant 
310:     ST  3,-17(1) 	Save index 
* EXPRESSION STMT
311:    LDC  3,666(6) 	Load constant 
312:     LD  4,-17(1) 	Restore index 
313:    LDA  5,-3(1) 	Load address of base of array q
314:    SUB  5,5,4 	Compute offset of value 
315:     LD  4,0(5) 	loah lhs variable q
316:    SUB  3,4,3 	op -= 
...
* 			Load param 1
319:    LDC  3,1(6) 	Load constant 
320:    LDA  4,-3(1) 	Load address of base of array q
321:    SUB  3,4(3) 	Compute offset for q
322:     LD  3,0(3) 	load value for q
...
* EXPRESSION STMT
* EXPRESSION STMT
333:    LDC  3,1(6) 	Load constant 
334:     ST  3,-17(1) 	Save index 
* EXPRESSION STMT
335:    LDC  3,3(6) 	Load constant 
...
* EXPRESSION STMT
340:    LDC  3,1(6) 	Load constant 
341:    LDA  4,-6(1) 	Load address of base of array b
342:    SUB  3,4(3) 	Compute offset for b
343:     LD  3,0(3) 	load value for b
344:     ST  3,-17(1) 	Save left side 
* EXPRESSION STMT
345:    LDC  3,1(6) 	Load constant 
346:     LD  4,-17(1) 	Load left into ac1 
347:    ADD  3,4,3 	Op + 
348:     ST  3,-17(1) 	Save index 
* EXPRESSION STMT
349:    LDC  3,777(6) 	Load constant 
350:     LD  4,-17(1) 	Restore index 
351:    LDA  5,-6(1) 	Load address of base of array q
...
357:    SUB  3,4(3) 	Compute offset for b
358:     LD  3,0(3) 	load value for b
359:     ST  3,-19(1) 	Save left side 
* EXPRESSION STMT
360:    LDC  3,1(6) 	Load constant 
361:     LD  4,-19(1) 	Load left into ac1 
362:    ADD  3,4,3 	Op + 
363:    LDA  4,-6(1) 	Load address of base of array q
364:    SUB  3,4(3) 	Compute offset for q
365:     LD  3,0(3) 	load value for q
...
373:    SUB  3,4(3) 	Compute offset for b
374:     LD  3,0(3) 	load value for b
...
* EXPRESSION STMT
380:    LDC  3,666(6) 	Load constant 
381:     LD  4,-17(1) 	Restore index 
382:    LDA  5,-6(1) 	Load address of base of array q
383:    SUB  5,5,4 	Compute offset of value 
384:     LD  4,0(5) 	loah lhs variable q
385:    ADD  3,4,3 	op += 
...
390:    SUB  3,4(3) 	Compute offset for b
391:     LD  3,0(3) 	load value for b
392:     ST  3,-19(1) 	Save left side 
* EXPRESSION STMT
393:    LDC  3,1(6) 	Load constant 
394:     LD  4,-19(1) 	Load left into ac1 
395:    ADD  3,4,3 	Op + 
396:    LDA  4,-6(1) 	Load address of base of array q
397:    SUB  3,4(3) 	Compute offset for q
398:     LD  3,0(3) 	load value for q
...
406:    SUB  3,4(3) 	Compute offset for b
407:     LD  3,0(3) 	load value for b
...
* EXPRESSION STMT
413:    LDC  3,666(6) 	Load constant 
414:     LD  4,-17(1) 	Restore index 
415:    LDA  5,-6(1) 	Load address of base of array q
416:    SUB  5,5,4 	Compute offset of value 
417:     LD  4,0(5) 	loah lhs variable q
418:    SUB  3,4,3 	op -= 
...
* 			Load param 1
421:    LDC  3,1(6) 	Load constant 
422:    LDA  4,-6(1) 	Load address of base of array b
423:    SUB  3,4(3) 	Compute offset for b
424:     LD  3,0(3) 	load value for b
425:     ST  3,-19(1) 	Save left side 
* EXPRESSION STMT
426:    LDC  3,1(6) 	Load constant 
427:     LD  4,-19(1) 	Load left into ac1 
428:    ADD  3,4,3 	Op + 
429:    LDA  4,-6(1) 	Load address of base of array q
430:    SUB  3,4(3) 	Compute offset for q
431:     LD  3,0(3) 	load value for q
...
* EXPRESSION STMT
* EXPRESSION STMT
481:    LDC  3,1(6) 	Load constant 
482:     ST  3,-17(1) 	Save index 
* EXPRESSION STMT
483:    LDC  3,2(6) 	Load constant 
484:     ST  3,-18(1) 	Save index 
* EXPRESSION STMT
485:    LDC  3,777(6) 	Load constant 
...
* 			Load param 1
495:    LDC  3,1(6) 	Load constant 
496:    LDA  4,-6(1) 	Load address of base of array b
497:    SUB  3,4(3) 	Compute offset for b
498:     LD  3,0(3) 	load value for b
...
* 			Load param 1
520:    LDC  3,1(6) 	Load constant 
521:    LDA  4,-6(1) 	Load address of base of array b
522:    SUB  3,4(3) 	Compute offset for b
523:     LD  3,0(3) 	load value for b
...
547:    SUB  3,4(3) 	Compute offset for b
548:     LD  3,0(3) 	load value for b
...
614:    SUB  3,4(3) 	Compute offset for qq
615:     LD  3,0(3) 	load value for qq
...
631:    LDC  3,10(6) 	load size of array h
632:     ST  3,-1(0) 	saves size of array h
* END init of globals
633:    LDA  1,-12(0) 	set first frame at end of globals 
