...
* EXPRESSION STMT
105:    LDC  3,6(6) 	Load constant 
106:     ST  3,-13(1) 	Save index 
107:    LDC  3,6(6) 	Load constant 
...
* EXPRESSION STMT
130:    LDC  3,10(6) 	Load constant 
131:     ST  3,-14(1) 	Save index 
132:    LDC  3,111(6) 	Load constant 
...
*                       End call to output
* EXPRESSION STMT
154:    LDC  3,10(6) 	Load constant 
155:     ST  3,-14(1) 	Save index 
156:    LDC  3,222(6) 	Load constant 
...
209:    LDC  3,10(6) 	load size of array z-1
210:     ST  3,-13(0) 	save size of array z-1
211:    LDC  3,13(6) 	load size of array z-2
212:     ST  3,-24(0) 	save size of array z-2
* END init of globals
213:    LDA  1,-38(0) 	set first frame at end of globals 
214:     ST  1,0(1) 	store old fp (point to self) 
