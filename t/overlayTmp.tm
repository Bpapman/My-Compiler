...
*                       End call to dog
 ...
 67:    ADD  3,4,3 	Op + 
 68:     ST  3,-3(1) 	Store variable x
* EXPRESSION STMT
*                       Begin call to  output
 69:     ST  1,-5(1) 	Store old fp in ghost frame 
*                       Load param 1
 70:     LD  3,-3(1) 	Load variable x
...
*                       End call to dog
 ...
 93:    ADD  3,4,3 	Op + 
 94:     ST  3,-4(1) 	Store variable y
* EXPRESSION STMT
*                       Begin call to  output
 95:     ST  1,-5(1) 	Store old fp in ghost frame 
*                       Load param 1
 96:     LD  3,-4(1) 	Load variable y
 97:     ST  3,-7(1) 	Store parameter 
*                       Jump to output
 98:    LDA  1,-5(1) 	Load address of new frame 
...
117:    ADD  3,4,3 	Op + 
118:     ST  3,-2(1) 	Store variable z
* EXPRESSION STMT
*                       Begin call to  output
119:     ST  1,-5(1) 	Store old fp in ghost frame 
*                       Load param 1
120:     LD  3,-2(1) 	Load variable z
...
* EXPRESSION STMT
*                       Begin call to  outnl
126:     ST  1,-5(1) 	Store old fp in ghost frame 
*                       Jump to outnl
