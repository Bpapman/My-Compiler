...
* EXPRESSION STMT
 92:    LDC  3,4(6) 	Load constant 
 93:     ST  3,-1(0) 	Store variable y
* EXPRESSION STMT
 94:    LDC  3,5(6) 	Load constant 
...
* BEGIN compound statement
* EXPRESSION STMT
101:    LDC  3,6(6) 	Load constant 
102:     ST  3,-2(1) 	Store variable a
* EXPRESSION STMT
103:    LDC  3,7(6) 	Load constant 
104:     ST  3,-3(1) 	Store variable b
* EXPRESSION STMT
105:    LDC  3,8(6) 	Load constant 
106:     ST  3,0(0) 	Store variable x
* EXPRESSION STMT
107:    LDC  3,9(6) 	Load constant 
...
* BEGIN compound statement
* EXPRESSION STMT
146:    LDC  3,666(6) 	Load constant 
147:     ST  3,-5(1) 	Store variable a
* EXPRESSION STMT
148:    LDC  3,666(6) 	Load constant 
149:     ST  3,-6(1) 	Store variable b
* EXPRESSION STMT
150:    LDC  3,666(6) 	Load constant 
...
*                       End call to output
* EXPRESSION STMT
267:    LDC  3,16(6) 	Load constant 
268:     ST  3,-5(1) 	Store variable a
* EXPRESSION STMT
269:    LDC  3,17(6) 	Load constant 
270:     ST  3,-6(1) 	Store variable b
* EXPRESSION STMT
271:    LDC  3,18(6) 	Load constant 
272:     ST  3,0(0) 	Store variable x
* EXPRESSION STMT
273:    LDC  3,19(6) 	Load constant 
274:     ST  3,-1(0) 	Store variable y
* EXPRESSION STMT
275:    LDC  3,20(6) 	Load constant 
