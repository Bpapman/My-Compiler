...
* EXPRESSION STMT
*                       Begin call to  output
 79:     ST  1,-107(1) 	Store old fp in ghost frame 
*                       Load param 1
 80:    LDA  3,-40(0) 	Load address of base of array ds
 81:     LD  3,1(3) 	Load array size 
 82:     ST  3,-109(1) 	Store parameter 
*                       Jump to output
 83:    LDA  1,-107(1) 	Load address of new frame 
...
* BEGIN compound statement
 ...
 88:     ST  3,-62(1) 	save size of array d
* EXPRESSION STMT
*                       Begin call to  output
 89:     ST  1,-107(1) 	Store old fp in ghost frame 
*                       Load param 1
 90:    LDA  3,-2(0) 	Load address of base of array h
 91:     LD  3,1(3) 	Load array size 
 92:     ST  3,-109(1) 	Store parameter 
*                       Jump to output
 93:    LDA  1,-107(1) 	Load address of new frame 
...
* EXPRESSION STMT
*                       Begin call to  output
 97:     ST  1,-107(1) 	Store old fp in ghost frame 
*                       Load param 1
 98:    LDA  3,-4(1) 	Load address of base of array b
 99:     LD  3,1(3) 	Load array size 
100:     ST  3,-109(1) 	Store parameter 
*                       Jump to output
101:    LDA  1,-107(1) 	Load address of new frame 
...
* EXPRESSION STMT
*                       Begin call to  output
105:     ST  1,-107(1) 	Store old fp in ghost frame 
*                       Load param 1
106:    LDA  3,-15(0) 	Load address of base of array bs
107:     LD  3,1(3) 	Load array size 
108:     ST  3,-109(1) 	Store parameter 
*                       Jump to output
109:    LDA  1,-107(1) 	Load address of new frame 
...
* EXPRESSION STMT
*                       Begin call to  output
113:     ST  1,-107(1) 	Store old fp in ghost frame 
*                       Load param 1
114:    LDA  3,-63(1) 	Load address of base of array d
115:     LD  3,1(3) 	Load array size 
116:     ST  3,-109(1) 	Store parameter 
*                       Jump to output
117:    LDA  1,-107(1) 	Load address of new frame 
...
* EXPRESSION STMT
*                       Begin call to  output
121:     ST  1,-107(1) 	Store old fp in ghost frame 
*                       Load param 1
122:    LDA  3,-76(0) 	Load address of base of array ds
123:     LD  3,1(3) 	Load array size 
124:     ST  3,-109(1) 	Store parameter 
*                       Jump to output
125:    LDA  1,-107(1) 	Load address of new frame 
...
162:    LDC  3,11(6) 	load size of array h
163:     ST  3,-1(0) 	save size of array h
...
170:    LDC  3,55(6) 	load size of array j
171:     ST  3,-122(0) 	save size of array j
* END init of globals
172:    LDA  1,-178(0) 	set first frame at end of globals 
