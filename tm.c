...
/*                                                            */
/* v3.01    Added array/character commands, incrementing      */
...
char *versionNumber =(char *)"TM version 3.01";
...
typedef enum
{
    ...
    opSTR,                      /* RR     dMem[reg[r] + (0..reg[t]-1)] = reg[s] */
    opCMP,                      /* RR     reg[5] =  0 if equal or dMem[reg[r] + k] - dMem[reg[s] + k], reg[6]=0 or k */
    ...
    opSET,                      /* RR     dMem[reg[r] + (0..reg[s]-1)] = d */
...
char *opCodeTab[] = {
    /* RO opcodes */
    (char *)"HALT", (char *)"NOP", (char *)"IN", (char *)"INB", (char *)"INC", (char *)"OUT", (char *)"OUTB", (char *)"OUTC", (char *)"OUTNL", (char *)"ADD", (char *)"SUB", (char *)"MUL", (char *)"DIV", (char *)"SWP", (char *)"MOV", (char *)"STR", (char *)"CMP", (char *)"????",
    /* RA opcodes */
    (char *)"LD", (char *)"LDI", (char *)"ST", (char *)"STI", (char *)"SCI",
    (char *)"LDA", (char *)"LDC", (char *)"JLT", (char *)"JLE", (char *)"JGT", (char *)"JGE", (char *)"JEQ", (char *)"JNE", (char *)"SET", (char *)"????"
};
		...
		return error(errorString, lineNo, loc);
            ...
            if (op==opHALT || op==opNOP) {
                ...
                case opclRA:
                    /***********************************/
                    /* arg 1 */
                    if (!getNum() || op!=opSCI && ((num<0) || (num >= NO_REGS)))
                        return error((char *)"Bad first register", lineNo, loc);
                    arg1 = num;
                    if (!skipCh(','))
                        return error((char *)"Missing comma", lineNo, loc);
...
STEPRESULT stepTM(void)
{
    ...
    case opCMP: {
        ...
        same = 1;
        for (i=0; i<reg[t]; i++) {
            if (dMem[raddr] != dMem[saddr]) {
                reg[5] = dMem[raddr] - dMem[saddr];
                same = 0;
                break;
            }
            raddr++;
