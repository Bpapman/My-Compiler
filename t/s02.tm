...
* EXPRESSION STMT
 ...
 57:     ST  3,-104(0) 	Store variable runningSum
 55:    LDA  7,2(7) 	Jump around the THEN [backpatch] 
* ENDIF
* EXPRESSION STMT
 58:     LD  3,-3(1) 	Load variable x
 59:     LD  4,-104(0) 	load lhs variable runningSum
 60:    ADD  3,4,3 	op += 
 61:     ST  3,-104(0) 	Store variable runningSum
* RETURN
 62:     LD  3,-104(0) 	Load variable runningSum
...
* EXPRESSION STMT
 ...
 73:     ST  3,-2(0) 	Store variable runningSum
* EXPRESSION STMT
*                       Begin call to  output
 74:     ST  1,-2(1) 	Store old fp in ghost frame 
*                       Load param 1
 75:     LD  3,-2(0) 	Load variable runningSum
...
*                       Load param 1
115:     LD  3,-2(0) 	Load variable runningSum
...
127:     ST  3,-3(0) 	save size of array x
* END init of globals
128:    LDA  1,-105(0) 	set first frame at end of globals 
